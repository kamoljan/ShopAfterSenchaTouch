 ...
 */
Ext.define('ShopAfter.controller.Ads', {
    ...
    onAdTap: function (record) {
        ...
        ShopAfter.app.updateUrl('ad/' + record.get('_id'));
        this.showAd(record);
    },
    ...
    onAdUrl: function (adId) {
        ...
        if (ad) {
            ...
            ShopAfter.model.InsertAdForm.load(adId, {
                success: function (ad) {
                    this.showAd(ad);
                },
                scope: this
    ...
    onAdShare: function () {
        ...
        var me = this;
        Ext.create('ShopAfter.view.Dialog', {
    ...
    onPlayTrailer: function (ad) {
        ...
        ShopAfter.app.getController('YouTube').showTrailer(videoId[1]);
    },
                ...
                buttons: [
                    {
                        ...
                        handler: function () {
                            window.location = ShopAfter.Facebook.redirectUrl();
                        }
                    }
                ]
            }).show();
    ...
    validateAdForm: function (button, e, options) {
        ...
        var model = Ext.create('ShopAfter.model.InsertAdForm', form.getValues());
